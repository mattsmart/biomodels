...
FEEDBACK_SHAPES = ["constant", "hill", "step", "pwlinear", "hillorig", "tanh"]
...
COLOURS_DARK_BLUE = [Z_DARK, '#9799BA', BLUE, X_DARK]
COLOURS_DARK_BLUE_YELLOW = [Z_DARK, '#ffd966', BLUE, X_DARK]
