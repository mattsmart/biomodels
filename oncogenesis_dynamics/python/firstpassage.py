...
def fast_mean_fpt_varying(param_vary_name, param_vary_values, params, system, num_processes, samplesize=30):
    ...
    return mean_fpt_varying


def plot_mean_fpt_varying(mean_fpt_varying, param_vary_name, param_set, params, system, samplesize, show_flag=False, figname_mod=""):
    plt.plot(param_set, mean_fpt_varying, 'o')
