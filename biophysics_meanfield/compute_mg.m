function outputs = compute_mg(n1,np)
...
function get_custom_data = get_custom_data()
    ...
    filename = sprintf('data\\mg_data_na_%d_mM_amp_%1.1f_muM_k_%d.txt', 1000*n1, 1e6*np, k0);
    fid = fopen(filename, 'w');
    col_id = sprintf('_na_%d_amp_%1.1f_k_%d', 1000*n1, 1e6*np, k0);
