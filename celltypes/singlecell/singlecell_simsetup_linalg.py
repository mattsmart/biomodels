...
if __name__ == '__main__':
    ...
    print "effect of stabilizing field on well depth"
    print [-np.dot(XI_EXTEND[:, i], hstb_naive) for i in xrange(P)]
    ...
    print "effect of stabilizing field on well depth"
    print [-np.dot(XI_EXTEND[:, i], hstb_proj) for i in xrange(P)]
    ...
    print "effect of stabilizing field on well depth"
    print [-np.dot(XI_EXTEND[:, i], hstb_anchor) for i in xrange(P)]